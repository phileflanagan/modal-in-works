<div class="lec-form">
    <form id="swpm-registration-form" name="swpm-registration-form" method="post" action="">
        <input type ="hidden" name="level_identifier" value="<?php echo $level_identifier ?>" />
             <label for="user_name"><?php echo SwpmUtils::_('Username / Company*') ?></label>
        ...
        <div class="swpm-registration-submit-section" align="left">
            <input class="form-button-gray" type="submit" value="<?php echo SwpmUtils::_('Register') ?>" class="swpm-registration-submit" name="swpm_registration_submit" />
        </div>
